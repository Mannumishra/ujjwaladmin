...
const UpdateTestimonial = () => {
    ...
    const postData = async (e) => {
        e.preventDefault();
        try {
            const res = await axios.put(`https://ujjwalbackend.onrender.com/api/category/api/testimonial/${_id}`, formData);
            if (res.status === 200) {
    ...
    const getApiData = async () => {
        try {
            const res = await axios.get(`https://ujjwalbackend.onrender.com/api/category/api/testimonial/${_id}`);
