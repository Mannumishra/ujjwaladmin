            ...
            <div className="container-fluid" style={{ marginTop: 70 }}>
                <div className="row">
                    ...
                    <div className="col-md-9">
                        <h2 className='p-2 test-light text-center'>Update Banner</h2>
                        <div className="form-container">
                            <form onSubmit={postData}>
                                ...
                                <button type="submit" className="btn btn-success w-100" disabled={loading} style={{backgroundColor:"#28a745"}}>
